...
curl -d "name=rdn-toy-owdcmeqn&category=Videogames" -X PUT http://127.0.0.1:5000/toys/2
curl -X DELETE http://127.0.0.1:5000/toys/4

# elves
curl http://127.0.0.1:5000/elves
curl http://127.0.0.1:5000/elves/1
curl -d "first_name=Cathrine&last_name=Kohler&login=login-xszce&password=secret" -X POST http://127.0.0.1:5000/elves
...
curl -d "child_name=Bobby&toy=Chess" -X POST http://127.0.0.1:5000/whishes
